...
const HomePage = () => {
        ...
        //   dispatch(getProductRequest());
        //   axios
        //     .get("http://localhost:8080/motorcyles")
        //     .then((res) => dispatch(getProductSuccess(res.data)))
        //     .catch((err) => dispatch(getProductFailure(err)));
        // };
  ...
  return (
      ...
      <div className="bannerChildDiv">
        <div className="menuBar">
          ...
          <div className="otherQuickOptions">
            ...
            <span style={{color:"#002f34"}}>For Sale:Houses & Apartments</span>
            <span style={{color:"#002f34"}}>Scooters</span>
            <span style={{color:"#002f34"}}>Commercials & Other Vehicles </span>
            <span style={{color:"#002f34"}}>Houses</span>
          </div>
        </div>
    ...
    <div style={{backgroundColor:"#ebeeef",width:"95%",margin:"auto",marginTop:"7%",marginBottom:"5%"}}>

      <div style={{display:"flex",justifyContent:"space-between"}}>
        <div>
        <h1 style={{color:"#002f34",font:"26px Roboto", marginLeft:"20px"}}>More on motorcycles</h1>  </div>
        <div style={{color:"#002f34",font:"20px Roboto"}}>View More</div>
        ...
        <Slider {...settings}>
          ...
          <div>
            <img style={{height:"250px",width:"220px"}} src="https://apollo-singapore.akamaized.net/v1/files/l3w9rdbkx9dv2-IN/image;s=300x600;q=60" alt="" />
          <h3>1,50,000</h3>
          <h3>Pulsar</h3>
          ...
          <div>
          <div>
            <img style={{height:"250px",width:"220px"}} src="https://apollo-singapore.akamaized.net/v1/files/9b3bdcyhiy2h-IN/image;s=300x600;q=60" alt="" />
          <h1 style={{color:"#002f34",size:"180px"}}> 100000</h1>
          <h3>Duke 390</h3>
          ...
          <div>
          <div>
            <img style={{height:"250px",width:"220px"}} src="https://apollo-singapore.akamaized.net/v1/files/2rdzl2k5gicj2-IN/image;s=300x600;q=60" alt="" />
          <h1 style={{color:"#002f34",size:"180px"}}> 100000</h1>
          <h3>Duke 180</h3>
          ...
          <div>
          <div>
            <img style={{height:"250px",width:"220px"}} src="https://apollo-singapore.akamaized.net/v1/files/nfhajwbon3g51-IN/image;s=300x600;q=60" alt="" />
          <h1 style={{color:"#002f34",size:"180px"}}> 100000</h1>
          <h3>Pulsar</h3>
          ...
          <div>
          <div>
            <img style={{height:"250px",width:"220px"}} src="https://apollo-singapore.akamaized.net/v1/files/v5vanp1b872y-IN/image;s=300x600;q=60" alt="" />
          <h1 style={{color:"#002f34",size:"180px"}}> 100000</h1>
          <h3>Pulsar</h3>
          <h3>Ktm</h3>
          </div>
...
{/* 
<div  style={{color:"#002f34",font:"26px Roboto"}}>

        <p style={{ marginLeft:"10px"}}>Fresh Recommendations</p>  */}
    

<div >
  <p style={{color:"#002f34",font:"28px Roboto",textAlign:"left",marginLeft:"30px",}}>Fresh Recommendations</p>
  </div>
   ...
   {products.map((e) => {
     ...
     return (
       ...
       <div  className="prt-div" key={id}>
         ...
         <img style= {{height:"220px",width:"220px"}} src={img}></img>
         <div className="view">
         ...
         <div className="prt-name"><h4 style={{color:"black",}}>{price}</h4></div>
