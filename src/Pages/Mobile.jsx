  ...
  return (
    <div>
      ...
      <div className="mobile_div1">
        <p className="mobile_div1_innerTitle">SELECTED CATEGORY</p>
        <div style={{ display: "flex", padding: "2%" }}>
          <p className="mobile_div1_innerTitle2"> Mobile / Mobile phones</p>
          <Link className="mobile_div1_link1" to={"/adddata"}>
            Change
          </Link>
        </div>
        <hr />
        ...
        <p className="mobile_div_body_ad_Title">Ad Title *</p>
        <input
          type="text"
          maxLength={"70"}
          required
          className="mobile_div_input_tag"
        />
        <br />
        ...
        <textarea
          maxLength="2000"
          className="mobile_div_input_tag_description"
          rows="4"
          cols="50"
        ></textarea>
        <br />
        ...
        <input
          type="number"
          placeholder=""
          className="mobile_div_input_price"
        />
